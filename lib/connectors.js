...
// Defined connectors.
var connectorsData = require(process.cwd()+"/config/connectors");
...
module.exports.connect = function(next) {
  ...
  var connectorNames = Object.keys(connectorsData);
  // recursive function that loads each connector
  var loadNext = function(nextIndex) {
    var connectorName = connectorNames[nextIndex];
    var connectorData = connectorsData[connectorName];
    if (connectorData) {
...
module.exports.disconnect = function(next) {
  // list of defined connectors
  var connectorNames = Object.keys(connections);
  // recursive function that disconnects each connector
  var disconnectNext = function(nextIndex) {
    var connectorName = connectorNames[nextIndex];
    if (connectorName) {
